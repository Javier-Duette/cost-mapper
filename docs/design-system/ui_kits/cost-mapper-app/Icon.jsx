/* Icon helper — loads inline SVG strings keyed by name.
   Uses currentColor so CSS controls the tint. */
const CMIcons = {
  ...
  library:    `<path d="M4 5.5 a1.5 1.5 0 0 1 1.5 -1.5 H10 a1.5 1.5 0 0 1 1.5 1.5 V20 H5.5 a1.5 1.5 0 0 1 -1.5 -1.5 Z"/><path d="M12.5 5.5 a1.5 1.5 0 0 1 1.5 -1.5 H18.5 a1.5 1.5 0 0 1 1.5 1.5 V18.5 a1.5 1.5 0 0 1 -1.5 1.5 H12.5 Z"/><line x1="6.5" y1="8" x2="9" y2="8"/><line x1="14.5" y1="8" x2="17.5" y2="8"/>`,
  ...
  expand:     `<polyline points="14.5,4 20,4 20,9.5"/><polyline points="9.5,20 4,20 4,14.5"/><line x1="20" y1="4" x2="14" y2="10"/><line x1="4" y1="20" x2="10" y2="14"/>`,
  collapse:   `<polyline points="20,9.5 14.5,9.5 14.5,4"/><polyline points="4,14.5 9.5,14.5 9.5,20"/><line x1="14.5" y1="9.5" x2="20" y2="4"/><line x1="9.5" y1="14.5" x2="4" y2="20"/>`,
  ...
  zoom_extents:`<polyline points="9,4 4,4 4,9"/><polyline points="15,4 20,4 20,9"/><polyline points="20,15 20,20 15,20"/><polyline points="9,20 4,20 4,15"/><line x1="4" y1="4" x2="9" y2="9"/><line x1="20" y1="4" x2="15" y2="9"/><line x1="20" y1="20" x2="15" y2="15"/><line x1="4" y1="20" x2="9" y2="15"/>`,
  reset:      `<path d="M4 12 a8 8 0 0 1 13.5 -5.5"/><polyline points="14,3 17.5,6.5 14,10"/>`,
  wireframe:  `<path d="M12 3.5 L20.5 7.5 L20.5 16.5 L12 20.5 L3.5 16.5 L3.5 7.5 Z" stroke-dasharray="2 2"/><path d="M3.5 7.5 L12 11.5 L20.5 7.5" stroke-dasharray="2 2"/><path d="M12 11.5 L12 20.5" stroke-dasharray="2 2"/>`,
  ...
  drag_v:     `<line x1="6" y1="9" x2="18" y2="9"/><line x1="6" y1="15" x2="18" y2="15"/>`,
};

function Icon({ name, size = 16, ...rest }) {
  const body = CMIcons[name];
  if (!body) return null;
  return (
    <svg
